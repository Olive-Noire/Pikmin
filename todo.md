...
<ins>Note :</ins> peut être qu'il faudrait supprimer les fonctions `update_surface` et gérer ça uniquement dans les fonctions `update` pour que ce soit plus fin...
